class DiscussionsController < ApplicationController
  ...
  def set_owned_discussion
    begin
      ...
      logger.info "============"
      if user_logged_in?
        logger.info "#{current_user.name} attempting edit of discussion #{params[:id]}, but they don't own it."
      end
      logger.info e
      logger.info "============"
      flash[:notice] = "You do not have permissions to do that. Must be discussion owner."
